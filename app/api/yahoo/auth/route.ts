      ...
      return NextResponse.json(
        {
          ...
          details:
            'YAHOO_CONSUMER_KEY and YAHOO_CONSUMER_SECRET must be set in Vercel environment variables',
        },
        { status: 500 },
      )
    }

    // Derive the redirect_uri from this deployment so preview/prod each send a
    // URI that matches what is registered in the Yahoo Developer app.
